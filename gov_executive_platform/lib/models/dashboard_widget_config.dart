...
class DashboardWidgetConfig {
  ...
  static List<DashboardWidgetConfig> defaults() => const [
        DashboardWidgetConfig(id: 'default_1', type: DashboardWidgetType.deptBarChart),
        DashboardWidgetConfig(id: 'default_2', type: DashboardWidgetType.statusPieChart),
        DashboardWidgetConfig(id: 'default_3', type: DashboardWidgetType.pendingApprovalsList),
        DashboardWidgetConfig(id: 'default_4', type: DashboardWidgetType.departmentRankingList),
      ];
}
