...
enum ApprovalType {
  ...
  departmentTransfer,
  // ــــ نقلُ **موظّف** من إدارة إلى أخرى ــــ
  //
  // **وهو غيرُ `departmentTransfer` أعلاه**: تلك تنقل مشروعاً، وهذه تنقل
  // إنساناً. واسمان متقاربان لشيئين مختلفين أوّلُ ما يُوقع في الخطأ — فيُفرَّق
  // بينهما في التعداد وفي بطاقة القرار وفي سجل التدقيق.
  //
  // يرفعُه مديرُ الإدارة بسببٍ مكتوب، **ولا يبتّ فيه إلا مسؤولُ النظام**:
