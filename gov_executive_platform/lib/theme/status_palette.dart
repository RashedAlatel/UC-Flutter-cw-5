...
class StatusPalette {
  ...
  /// نغمةُ حالةِ أصلٍ تقنيّ.
  ///
  /// و«متعثّر» خطرٌ لا تحذير: النظامُ يعمل بعُرجٍ والخدمةُ تتأثّر الآن.
  /// و«خارج الخدمة» محايدٌ لا نجاح: خروجُه قرارٌ لا إنجاز.
  static StatusTone assetTone(String status) => switch (status) {
        'live' => success,
        'pilot' => info,
        'degraded' => danger,
        'retired' => neutral,
