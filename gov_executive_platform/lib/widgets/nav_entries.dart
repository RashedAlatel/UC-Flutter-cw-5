...
List<NavKey> navKeysFor(AppStore store) {
  ...
  // ــ والمشاكلُ والتغييراتُ لمكتب الخدمة وحدَه ــ
  //
  // بخلاف «البلاغات» التي هي لكلّ موظّف: المشكلةُ تحليلٌ داخليّ، والتغييرُ
  // يحمل تفاصيلَ بنيةٍ تقنيّة وخطّةَ تراجع. والقاعدةُ تردّ قراءتَهما عمّن
  // لا يحمل `htk`، فمدخلٌ يظهر له يَعِدُ بما يرفضه الخادم.
