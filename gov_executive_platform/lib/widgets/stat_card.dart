...
class StatCard extends StatelessWidget {
  ...
  ///
  /// ــــ ولماذا مئةٌ لا مئةٌ وثمانية ــــ
  ///
  /// كُتبت ١٠٨ ابتداءً بالتقدير. ولمّا انتقلت الشاشاتُ الخمس إليها **قاس
  /// `card_blank_test.dart`** فراغاً مفروضاً قدره ٣٤ بكسلاً داخل البطاقة:
  /// المحتوى (عنوانٌ ثمّ رقم) يُوسَّط، فيتوزّع الزائدُ على الطرفين. وعلى
  /// ١٠٠ نزل إلى ٢٦ **بلا أن يخرج نصٌّ واحد** — ويقيس ذلك
  /// `card_overflow_test.dart` على مقاسَي آيفون SE و١٦ برو.
  ///
  /// وبالبكسل لا بنسبةٍ من العرض: النسبة تجعل الارتفاع تابعاً لعرض الشاشة،
  /// فيتضخّم الفراغُ كلما اتّسعت. ومحتوى هذه البطاقة ثابتٌ فارتفاعُه معروف.
  ///
  /// ويتّسع لعنوانٍ في سطرين: «متوسط التأخير عن الخطة» و«بلا تحديثٍ في
  /// الفترة» تلتفّان في العمود الضيّق.
